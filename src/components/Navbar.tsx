...
function ContactModal({ onClose, lang }: { onClose: () => void; lang: string }) {
    ...
    const handleSend = () => {
        ...
        window.location.href = `mailto:m.abdullahsyahroni@gmail.com?subject=${subject}&body=${body}`;
        setStatus("sent");
    };
            ...
            >
                ...
                <div className="contact-modal-content">
                    ...
                    <div style={{ display:"flex", justifyContent:"center", alignItems:"center", gap:12 }}>
                        ...
                        {[
                            { href:"https://www.linkedin.com/in/syahronii/", label:"LinkedIn",
                            ...
                            { href:"https://github.com/syahroni111", label:"GitHub",
                            ...
                            { href:"https://www.instagram.com/m.a_syahroni/", label:"Instagram",
